...
public class PalindromeCheckerApp {
    ...
    public static void main(String[] args) {
        ...
        run("UC02/UC03 - Basic Loop", input,
                PalindromeCheckerApp::basicLoop);

        // UC04
        run("UC04 - Character Array", input,
                PalindromeCheckerApp::charArrayMethod);

        // UC05
        run("UC05 - Stack", input,
                PalindromeCheckerApp::stackMethod);

        // UC06
        run("UC06 - Queue + Stack", input,
                PalindromeCheckerApp::queueStackMethod);

        // UC07
        run("UC07 - Deque", input,
                PalindromeCheckerApp::dequeMethod);

        // UC08
        run("UC08 - LinkedList", input,
                PalindromeCheckerApp::linkedListMethod);

        // UC09
        run("UC09 - Recursive", input,
                PalindromeCheckerApp::recursiveMethod);

        // UC10
        run("UC10 - Normalized", input,
                PalindromeCheckerApp::normalizedMethod);
